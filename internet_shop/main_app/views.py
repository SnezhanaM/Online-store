...
from .models import Smartphone, Audio, Category, LatestProducts, Customer, Cart, CartProduct
...
class BaseView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        products =LatestProducts.objects.get_latest_products(
            'smartphone', 'audio', with_respect_to='smartphone')
        context = {
...
class MakeOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.INFO, 'Спасибо за заказ! Наш менеджер с Вами свяжется для уточнения заказа.')
