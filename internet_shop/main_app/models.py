...
class CategoryManager(models.Manager):
    ...
    def get_categories_for_left_sidebar(self):
        models = get_models_for_count('smartphone', 'audio')
...
class Smartphone(Product):
    ...
    battery_capacity = models.CharField(max_length=250, verbose_name='Емкость аккумулятора')
...
class Order(models.Model):
    ...
    customer = models.ForeignKey(Customer, verbose_name='Покупатель', related_name='relates_orders', on_delete=models.CASCADE)
