...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main_app', '0006_auto_20210624_1710'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='relates_orders', to='main_app.customer', verbose_name='Покупатель')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
